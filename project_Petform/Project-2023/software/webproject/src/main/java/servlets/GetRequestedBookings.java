 ...
 * @author gioge
 */
@WebServlet(name = "GetRequestedBookings", urlPatterns = {"/GetRequestedBookings"})

public class GetRequestedBookings extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (keeperIdParam != null && !keeperIdParam.isEmpty()) {
                ...
                ArrayList<Booking> bookings = getRequestedBookings(keeperId, "requested");
    ...
    private ArrayList<Booking> getRequestedBookings(int keeperId, String status) {
